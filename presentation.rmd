...
```{r}
graph_influence_degree <- get_centrality(graph, centrality_degree(mode = 'out'), 0)
plot_centrality(graph_influence_degree)
...
subgraph_of_programming_language(graph_edge_betweenness, 'haskell')
