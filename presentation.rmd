...
plot_centrality <- function (graph_with_centrality, filtering_degree = 0, centrality_metric) {
  graph_with_centrality %>%
          ...
          labs(
            title = paste('Centrality metric:', centrality_metric)
          ) +
          theme_void()
}
...
* The metrics used for the first case are: in-degree, in-closeness, pagerank and betweenness
...
* Metrics used: out-degree, out-closeness
...
```{r Centrality Out-Closeness}
graph_closeness_centrality <- get_centrality(graph, centrality_closeness(mode = 'out'))
plot_centrality(graph_closeness_centrality, centrality_metric = 'out-closeness')
```

---

```{r}
plot_most_influent_languages(graph_closeness_centrality, centrality_metric = 'out-closeness')
```
...
plot_centrality(graph_authority, centrality_metric = 'authority')
